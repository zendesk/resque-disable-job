  ...
  module Plugins
    module DisableJob
      ...
      def before_perform_allow_disable_job(*args)
        p "before_perform_zzz_allow_disable_job", args, normalize_class_name(self)
      ...
      def disable_job(name, specific_args = {}, timeout = DEFAULT_TIMEOUT)
      ...
      def enable_job(name, specific_args = {})
      ...
      def remove_specific_setting(setting)
        Resque.redis.multi do
